...
import pe.edu.utp.controllers.AreasJpaController;
...
public class FrmArea extends javax.swing.JFrame {
    ...
    private AreasJpaController areasJpaController = new AreasJpaController();
    ...
    private void listar() {
        ...
        try {
            lista = areasJpaController.findAreasEntities();
            for (Area a : lista) {
                obj[0] = a.getId();
                obj[1] = a.getName();
